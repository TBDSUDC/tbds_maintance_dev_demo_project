...
public class HippoProduceDemo {
    ...
    private static final String CONTROLLER_IP_LIST="172.xx.xx.xx:8066";
    //Hipper Borker group
    ...
    private static final String ACCESS_ID="xxxxxxxxx";
    //Hipper access user
    private static final String USERNAME="admin";

    //topic
    private static final String[] topics = {"tx01"};
    ...
    public static void main(String[] args) throws Exception{
        ...
        for(int i=0;i<=100;i++){
            String content = "Tesing information["+i+"]";
            Message msg = new Message("tx01",content.getBytes());
