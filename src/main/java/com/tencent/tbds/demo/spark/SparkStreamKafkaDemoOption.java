...
public class SparkStreamKafkaDemoOption {
    ...
    private final OptionSpec<Integer> batchDuration;

    public SparkStreamKafkaDemoOption(String[] args) {
        this.optionParser = new OptionParser();

        batchDuration = optionParser.accepts("batch-duration")
                .withRequiredArg()
                .ofType(Integer.class)
                .defaultsTo(10)
                .describedAs("the time interval at which streaming data will be divided into batches");
    ...
    public int getBatchDuration() {
        return optionSet.valueOf(batchDuration);
    }
}
